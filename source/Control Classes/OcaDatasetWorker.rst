...
:ref:`OcaRoot <ocaroot>` : :ref:`OcaWorker <ocaworker>` : :ref:`OcaDatasetWorker <ocadatasetworker>`

.. cpp:class:: OcaDatasetWorker: OcaWorker

    Abstract base class for Dataset Workers, i.e. Workers that perform
    operations on Datasets.

    **Properties**:


    .. _ocadatasetworker_classid:

    .. cpp:member:: static const OcaClassID ClassID = "1.1.7"
    ...
    .. _ocadatasetworker_classversion:
    ...
    .. _ocadatasetworker_datasetono:

    .. cpp:member:: OcaONo DatasetONo
    ...
    **Methods**:
    ...
    .. _ocadatasetworker_getdatasetono:

    .. cpp:function:: OcaStatus GetDatasetONo(OcaONo &ONo)

        Returns object number associated Dataset Object, or zero if no Dataset
        is associated. Note: There is no corresponding **Set(...)** method,
        because it is assumed the Dataset will be associated either at
        construction time, or by actions defined by child classes, e.g. the
        **Open(...)** method of the child class **OcaMediaRecorderPlayer**.
