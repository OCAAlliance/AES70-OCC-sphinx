...
:ref:`OcaRoot <ocaroot>` : :ref:`OcaWorker <ocaworker>` : :ref:`OcaActuator <ocaactuator>` : :ref:`OcaSignalOutput <ocasignaloutput>`

.. cpp:class:: OcaSignalOutput: OcaActuator

    A set of one or more non-network signal outputs. Number of channels is set
    at construction time. This class has no native properties or methods - they
    are all inherited from **OcaWorker** and above. It is defined as a separate
    class as an aid to enumeration and signal flow definition.

    **Properties**:


    .. _ocasignaloutput_classid:

    .. cpp:member:: static const OcaClassID ClassID = "1.1.1.19"
