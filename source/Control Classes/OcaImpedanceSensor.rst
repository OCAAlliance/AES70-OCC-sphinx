...
:ref:`OcaRoot <ocaroot>` : :ref:`OcaWorker <ocaworker>` : :ref:`OcaSensor <ocasensor>` : :ref:`OcaImpedanceSensor <ocaimpedancesensor>`

.. cpp:class:: OcaImpedanceSensor: OcaSensor

    Complex impedance sensor. Value shall be reported as a magnitude and a
    phase.

    **Properties**:


    .. _ocaimpedancesensor_classid:

    .. cpp:member:: static const OcaClassID ClassID = "1.1.2.9"
    ...
    .. _ocaimpedancesensor_classversion:
    ...
    **Methods**:
    ...
    .. _ocaimpedancesensor_getreading:
