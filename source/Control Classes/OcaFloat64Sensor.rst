...
:ref:`OcaRoot <ocaroot>` :raw:html:`&rarr;` :ref:`OcaWorker <ocaworker>` :raw:html:`&rarr;` :ref:`OcaSensor <ocasensor>` :raw:html:`&rarr;` :ref:`OcaBasicSensor <ocabasicsensor>` :raw:html:`&rarr;` :ref:`OcaFloat64Sensor <ocafloat64sensor>` 
...
.. cpp:class:: OcaFloat64Sensor: OcaBasicSensor
    ...
    **Properties**:
    ...
    .. _ocafloat64sensor_classid:

    .. cpp:member:: static const OcaClassID ClassID = "1.1.2.1.11"

        Number that uniquely identifies the class. Note that this differs from the object number, which identifies the instantiated object. This property is an override of the  **OcaRoot** property.

        This property has id ``5.1``.

    .. _ocafloat64sensor_classversion:
